...
public class SMTIBEA_Problem extends Problem {
	...
	public SMTIBEA_Problem(String fm, String augment, String mandatory, String dead, String seedfile) throws Exception {
		...
		loadSeed(seedfile);
		this.solutionType_ = new SMTIBEA_BinarySolution(this, numFeatures, fm, mandatoryFeaturesIndices,
				deadFeaturesIndices, seed);
		this.ftz = new FMToZ3();
		this.ftz.parseDimacs(new FileReader(fm));
		this.ftz.parseMandatory(new FileReader(mandatory));
		this.ftz.parseDead(new FileReader(dead));
		this.ftz.parseAugment(new FileReader(augment));
	}
