...
public class SMTIBEA_SinglePointCrossover extends Crossover {
	/**
	 * Valid solution types to apply this operator
	 */
	private static final List VALID_TYPES = Arrays.asList(SMTIBEA_BinarySolution.class, BinarySolutionType.class,
			BinaryRealSolutionType.class, IntSolutionType.class);
	 ...
	 */
	public SMTIBEA_SinglePointCrossover(HashMap<String, Object> parameters) {
		super(parameters);
		...
		try {
			if (PseudoRandom.randDouble() < probability) {
				if ((parent1.getType().getClass() == BinarySolutionType.class)
						...
						|| parent1.getType().getClass() == SMTIBEA_BinarySolution.class) {
